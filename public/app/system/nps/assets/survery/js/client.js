...
(function(_) {
    ...
    try {
        ...
        ;
        (0,
        _._F_toggles_initialize)([0x182800, ]);
        ...
        _.ka = "function" == typeof Object.create ? Object.create : function(a) {
            var b = function() {};
            b.prototype = a;
            return new b
        }
        ...
        t("Promise", function(a) {
            ...
            e.race = function(g) {
                return new e(function(h, k) {
                    for (var l = _.ha(g), n = l.next(); !n.done; n = l.next())
                        c(n.value).kb(h, k)
                }
                )
            }
...
*/
        ...
        ;
        _.nb = Array.prototype.forEach ? function(a, b) {
        ...
        ;
        _.pb = Array.prototype.every ? function(a, b) {
        ...
        _.Rb = String.prototype.repeat ? function(a, b) {
            return a.repeat(b)
        }
        : function(a, b) {
        ...
        var Wb = function(a, b) {
            ...
            if (a) {
                ...
                this.screenY = d.screenY || 0) : (this.j = _.vb || void 0 !== a.offsetX ? a.offsetX : a.layerX,
        ...
        bc.prototype.add = function(a, b, c, d, e) {
            ...
            var g = cc(a, b, d, e);
            -1 < g ? (b = a[g],
            c || (b.jb = !1)) : (b = new $b(b,this.src,f,!!d,e),
            b.jb = c,
            a.push(b));
            return b
        }
        ...
        var cc = function(a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.Va && f.listener == b && f.capture == !!c && f.ya == d)
                    return e
            }
            return -1
        };
        ...
        _.ic = function(a, b, c, d, e) {
            ...
            c = _.jc(c);
            return _.Yb(a) ? a.Mb(b, c, _.$a(d) ? !!d.capture : !!d, e) : kc(a, b, c, !0, d, e)
        }
        ;
        pc = function(a, b, c, d, e) {
            if (Array.isArray(b))
                ...
                d = _.$a(d) ? !!d.capture : !!d,
                c = _.jc(c),
                _.Yb(a) ? a.Ga(b, c, d, e) : a && (a = _.lc(a)) && (b = a.Ra(b, c, d, e)) && _.qc(b)
        }
        ;
        _.qc = function(a) {
        ...
        _.Bc = function(a) {
            ...
            this.i = a.i,
            _.Ec(this, Fc(a.j)),
            this.m = a.m) : a && (b = String(a).match(_.xc)) ? (this.l = !1,
            _.Cc(this, b[1] || "", !0),
            this.o = Gc(b[2] || ""),
            this.g = Gc(b[3] || "", !0),
            _.Dc(this, b[4]),
...
*/
        ...
        vd = function(a) {
            var b = (0,
            _.td)(a);
            1 !== (b & 1) && (Object.isFrozen(a) && (a = _.sd(a)),
            (0,
            _.ud)(a, b | 1))
        }
        ;
        ...
        ;
        _.Kd = function(a, b, c) {
            if (null != a && "object" === typeof a && a.pb === _.Jd)
                return a;
            if (Array.isArray(a)) {
                var d = (0,
                _.td)(a)
        ...
        _.Qd = function(a) {
            ...
            case "object":
                if (a && !Array.isArray(a)) {
                    if (_.rd(a))
                        return _.pd(a);
                    if ("function" == typeof _.Pd && a instanceof _.Pd)
                        return a.Xc()
                }
            }
            return a
        ...
        Td = function(a, b, c, d, e, f) {
            if (null != a) {
                if (Array.isArray(a))
                    a = e && 0 == a.length && (0,
                    _.td)(a) & 1 ? void 0 : f && (0,
                    _.td)(a) & 2 ? a : Sd(a, b, c, void 0 !== d, e, f);
                else if (Bd(a)) {
                    var g = {}, h;
                    for (h in a)
                        g[h] = Td(a[h], b, c, d, e, f);
                    a = g
                } else
                    a = b(a, d);
                return a
        ...
        Sd = function(a, b, c, d, e, f) {
            ...
            _.td)(a) : 0;
            d = d ? !!(g & 32) : void 0;
            for (var h = _.sd(a), k = 0; k < h.length; k++)
                h[k] = Td(h[k], b, c, d, e, f);
            c && (Ed(h, a),
            c(g, h));
            return h
        }
        ...
        Vd = function(a, b, c) {
            ...
            if (null != a) {
                ...
                if (Array.isArray(a)) {
                    ...
                    return b ? ((0,
                    _.ud)(a, (d | 34) & -5),
                    a) : Sd(a, Vd, d & 4 ? zd : c, !0, !1, !0)
                }
                a.pb === _.Jd && (c = a.v,
                d = (0,
                _.H)(c),
                a = d & 2 ? a : _.Md(a.constructor, _.Wd(c, d, !0)));
                return a
            }
        }
        ;
            ...
            if (d) {
                ...
                for (var h, k, l = 0; l < d.length; l++)
                    ...
                    k < a) {
                        ...
                        h || (n = void 0,
                        e.length && Bd(n = e[e.length - 1]) ? h = n : e.push(h = {})),
                        n = h[k],
                        null == h[k] ? h[k] = c ? _.Yd : xd() : c && n !== _.Yd && vd(n)
            }
            d = b.length;
            if (!d)
                return b;
        ...
        ne = [];
        oe = function(a) {
            a.A && a.Wb && (a.A.ontimeout = null);
            a.rb && (_.u.clearTimeout(a.rb),
            a.rb = null)
        }
        ;
        pe = function(a) {
        ...
        ve = function(a) {
            if (a.oa && "undefined" != typeof _.Wa && (!a.tb[1] || 4 != te(a) || 2 != a.mb()))
                ...
                4 == te(a)) {
                    a.oa = !1;
                    try {
                        _.ue(a) ? (a.dispatchEvent("complete"),
                        a.dispatchEvent("success")) : qe(a)
                    } finally {
                        re(a)
                    }
                }
        ...
        xe = function(a) {
            ...
            this.tb = this.A = null;
            this.Lb = "";
            this.Ba = this.Ib = this.nb = this.Hb = !1;
            this.sb = 0;
            this.rb = null;
            this.Ac = "";
            this.Wb = this.Bd = this.Xb = !1;
        ...
        _.m.send = function(a, b, c, d) {
            ...
            _.cb)(this.yc, this);
            this.Bd && "onprogress"in this.A && (this.A.onprogress = (0,
            _.cb)(function(g) {
                this.xc(g, !0)
            }, this),
            this.A.upload && (this.A.upload.onprogress = (0,
            _.cb)(this.xc, this)));
            try {
                this.Ib = !0,
            ...
            !(0 <= (0,
            _.Na)(me, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
            b = _.ha(c);
            ...
            this.Ac && (this.A.responseType = this.Ac);
            "withCredentials"in this.A && this.A.withCredentials !== this.Xb && (this.A.withCredentials = this.Xb);
            if ("setTrustToken"in this.A && this.Vb)
                try {
                    this.A.setTrustToken(this.Vb)
                } catch (g) {}
            if ("setAttributionReporting"in this.A && this.Bb)
                try {
                    this.A.setAttributionReporting(this.Bb)
                } catch (g) {}
            try {
                oe(this),
                0 < this.sb && ((this.Wb = pe(this.A)) ? (this.A.timeout = this.sb,
                this.A.ontimeout = (0,
                _.cb)(this.Cc, this)) : this.rb = ke(this.Cc, this.sb, this)),
                this.nb = !0,
                this.A.send(a),
                this.nb = !1
            } catch (g) {
        ...
        ;
        _.m.Cc = function() {
            "undefined" != typeof _.Wa && this.A && (this.dispatchEvent("timeout"),
            this.abort(8))
        }
        ;
        _.m.abort = function() {
            this.A && this.oa && (this.oa = !1,
            this.Ba = !0,
            this.A.abort(),
            this.Ba = !1,
        ...
        ;
        _.m.yc = function() {
            this.sc() || (this.Ib || this.nb || this.Ba ? ve(this) : this.Ad())
        }
        ;
        _.m.Ad = function() {
            ve(this)
        ...
        _.m.getResponseHeader = function(a) {
            if (this.A && 4 == te(this))
                return a = this.A.getResponseHeader(a),
                null === a ? void 0 : a
        }
        ;
        ...
        ;
        ee = function(a) {
            a instanceof _.Nb || (a = "object" == typeof a && a.Aa ? a.g() : String(a),
            Ge.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Ae, "&amp;")),
        ...
        _.O.prototype.toJSON = function() {
            if (_.cf)
                var a = Zd(this, this.v, !1);
            else
                a = Sd(this.v, Ud, void 0, void 0, !1, !1),
                a = Zd(this, a, !0);
            return a
        }
        ;
        ...
        ;
        _.yf = [ce("data"), ce("http"), ce("https"), ce("mailto"), ce("ftp"), new _.be(function(a) {
            return /^[^:]*([/?#]|$)/.test(a)
        }
        )];
        _.zf = {};
        ...
        ;
        _.R = function(a) {
            return _.Ef(a, _.zf) ? a : a instanceof _.Nb ? (0,
            _.Q)(_.Ob(a).toString()) : a instanceof _.Nb ? (0,
            _.Q)(_.Ob(a).toString()) : (0,
            _.Q)(String(String(a)).replace(Gf, Hf), _.Ff(a))
        }
        ;
        _.Q = function(a) {
            function b(c) {
        ...
        _.S = function(a) {
            _.Ef(a, _.zf) ? (a = String(a.La).replace(Kf, "").replace(Lf, "&lt;"),
            a = _.Mf(a)) : a = String(a).replace(Gf, Hf);
            return a
        }
        ;
        _.Rf = function(a) {
            _.Ef(a, _.Af) || _.Ef(a, _.Bf) ? a = _.Nf(a) : a instanceof _.Fb ? a = _.Nf(_.Gb(a)) : a instanceof _.Fb ? a = _.Nf(_.Gb(a)) : a instanceof _.Oe ? a = _.Nf(_.Pe(a).toString()) : a instanceof _.Oe ? a = _.Nf(_.Pe(a).toString()) : (a = String(a),
            a = Of.test(a) ? a.replace(_.Pf, _.Qf) : "about:invalid#zSoyz");
            return a
        }
        ;
        Sf = {
        ...
        _.Xf = function(a) {
            a = a || {};
            return (a = a.identifier) ? "Conectado como " + a : "Conectado"
        }
        ;
        _.Yf = function(a) {
            return (0,
            _.Q)((a ? '<svg class="' + _.S("Bz112c") + " " + _.S("Bz112c-E3DyYd") + " " + _.S("Bz112c-uaxL4e") + '" aria-hidden=true viewBox="0 0 192 192">' : '<svg class="' + _.S("fFW7wc-ibnC6b-HiaYvf") + " " + _.S("zTETae-mzNpsf-Bz112c") + " " + _.S("n1UuX-DkfjY") + '" aria-hidden=true viewBox="0 0 192 192">') + '<path fill="#3185FF" d="M96 8C47.42 8 8 47.42 8 96s39.42 88 88 88 88-39.42 88-88S144.58 8 96 8z"/><path fill="#FFFFFF" d="M96 86c12.17 0 22-9.83 22-22s-9.83-22-22-22-22 9.83-22 22 9.83 22 22 22zM96 99c-26.89 0-48 13-48 25 10.17 15.64 27.97 26 48 26s37.83-10.36 48-26c0-12-21.11-25-48-25z"/></svg>')
        }
        ;
    ...
    try {
        ...
        _.Si = function(a, b, c) {
            ...
            if (b && 2 === _.E(b, 7)) {
                ...
                b && 2 === _.E(b, 10) && !_.P("disable_personalized_button") ? (c = void 0 === c ? !0 : c,
                b && _.hf(b, _.pf, 8) ? (d = {},
                b && (d = {
                    shape: _.E(b, 3),
                    text: _.E(b, 5),
                    theme: _.E(b, 2),
                    width: _.Id(_.E(b, 4)),
                    Ed: _.ge(_.M(b, _.pf, 8)),
                    Fd: _.Id(_.E(b, 9)),
                    Pa: c
                }),
                _.fe(a, Qi, d)) : Ri(a, b, c)) : Ri(a, b, c)
        }
        ;
        Ri = function(a, b, c) {
            c = void 0 === c ? !0 : c;
        ...
        var Xi = function(a) {
          ...
          , Zi = {}
          , $i = function(a, b) {
            return a && b && a.qd && b.qd ? a.va !== b.va ? !1 : a.toString() === b.toString() : a instanceof _.Cf && b instanceof _.Cf ? a.va != b.va ? !1 : a.toString() == b.toString() : a == b
        }
          , aj = function(a) {
          ...
          , cj = function(a) {
            _.Ef(a, Zi) ? a = aj(a.La) : null == a ? a = "" : a instanceof Ui ? a = aj(Vi(a)) : a instanceof Ui ? a = aj(Vi(a)) : a instanceof Wi ? a = aj(Xi(a)) : a instanceof Wi ? a = aj(Xi(a)) : (a = String(a),
            a = bj.test(a) ? a : "zSoyz");
            return a
        }
          , dj = function() {
            return (0,
            _.Q)('<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="' + _.S("LgbsSe-Bz112c") + '"><g><path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"/><path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"/><path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"/><path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"/><path fill="none" d="M0 0h48v48H0z"/></g></svg>')
        };
        _.ej = function(a) {
            this.v = _.G(a)
        }
        ...
        var jj = function(a, b, c, d, e, f, g, h) {
            ...
            return l(k + _.S(n) + " " + _.S(gj(c)) + " " + _.S(hj(d)) + '"' + (_.If(f) && !h ? ' style="width:' + _.S(cj(f)) + 'px; max-width:400px; min-width:min-content;"' : "") + '><div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-MJoBVe") + '"></div><div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + " " + ($i(a, 2) ? _.S("oXtfBe-l4eHX") : "") + '">' + ij($i(c, 2) || $i(c, 3)) + (h ? "" : '<span class="' + _.S("nsm7Bb-HzV7m-LgbsSe-BPrWId") + '">' + _.R(fj(e)) + "</span>") + '<span class="' + _.S("L6cTce") + '" id="button-label">' + g + "</span></div></div>")
        }
          , gj = function(a) {
            var b = "";
            switch (a) {
          ...
          , fj = function(a) {
            ...
            case 4:
                ...
                break;
            default:
                b += "Fazer login com o Google"
            }
            return b
        }
          , ij = function(a) {
            return (0,
            _.Q)((void 0 === a ? 0 : a) ? '<div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf") + '"><div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">' + dj() + "</div></div>" : '<div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">' + dj() + "</div>")
        };
        var Ti = function(a) {
            a = a || {};
            var b = a.Pa;
            return (0,
            _.Q)(jj(a.tc, a.size, a.theme, a.shape, a.text, a.width, void 0 === b ? !0 : b))
        }
          , Pi = function(a) {
            a = a || {};
            var b = a.Pa;
            return (0,
            _.Q)(jj(void 0, a.size, a.theme, a.shape, a.text, void 0, void 0 === b ? !0 : b, !0))
        }
          , Qi = function(a) {
            var b = a.Pa
              , c = a.Ed
            ...
            a = _.Q;
            b = void 0 === b ? !0 : b;
            b = "<div" + (void 0 === b || b ? ' tabindex="0"' : "") + ' role="button" aria-labelledby="button-label" class="' + _.S("nsm7Bb-HzV7m-LgbsSe") + " " + _.S("jVeSEe") + " " + _.S(gj(g)) + " " + _.S(hj(e)) + '" style="max-width:400px; min-width:200px;' + (h ? "width:" + _.S(cj(h)) + "px;" : "") + '"><div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-MJoBVe") + '"></div><div class="' + _.S("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + '">';
            e = c.givenName ? c.givenName : c.displayName;
            c.profilePicture ? (b += '<img class="' + _.S("n1UuX-DkfjY") + '" src="' + _.S(_.Rf(c.profilePicture)) + '" alt="',
            h = "Imagem do perfil de " + _.S(e ? e : c.id),
            b += _.Mf(h),
            b += '">') : b += _.Yf();
            ...
            if (e)
                ...
                case 4:
                    ...
                    break;
                default:
                    k += "Fazer login como " + e
                }
            else
                k += fj(f);
            b += h + _.R(k) + '</div><div class="' + _.S("K4efff") + '"><div class="' + _.S("fmcmS") + '">' + _.R(c.id) + "</div>" + (1 < d ? (0,
            _.Q)('<svg class="' + _.S("Bz112c") + " " + _.S("Bz112c-E3DyYd") + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path><path fill="none" d="M0 0h24v24H0V0z"></path></svg>') : "") + "</div></div>" + ij($i(g, 2) || $i(g, 3)) + "</div></div>";
            c = (0,
            _.Q)(b);
            return a(c)
        };
    ...
    try {
        ...
        _.Bj = function() {
            ...
            if (!(a = _.Ga() || (_.w("iPad") || _.w("iPhone")) && !_.Ga() && !_.Fa() && !(_.za() ? 0 : _.w("Coast")) && !_.Ea() && _.w("AppleWebKit")) && (a = _.La())) {
                a = _.ta();
                var b = "";
                (_.Ja() ? "Windows" === _.va.platform : _.w("Windows")) ? (b = /Windows (?:NT|Phone) ([0-9.]+)/,
                b = (a = b.exec(a)) ? a[1] : "0.0") : _.La() ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/,
                b = (a = b.exec(a)) && a[1].replace(/_/g, ".")) : _.Ma() ? (b = /Mac OS X ([0-9_.]+)/,
                b = (a = b.exec(a)) ? a[1].replace(/_/g, ".") : "10") : _.wa(_.ta().toLowerCase(), "kaios") ? (b = /(?:KaiOS)\/(\S+)/i,
                b = (a = b.exec(a)) && a[1]) : _.vj() ? (b = /Android\s+([^\);]+)(\)|;)/,
                b = (a = b.exec(a)) && a[1]) : _.wj() && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/,
                b = (a = b.exec(a)) && a[1]);
                a = 0 <= _.Aj(b || "", "14.4")
            }
    ...
    try {
        ...
        _.tl = function(a) {
            ...
            a: if (b = void 0 === b ? _.yf : b,
            !(a instanceof _.Fb)) {
                for (var c = 0; c < b.length; ++c) {
                    var d = b[c];
                    if (d instanceof _.be && d.rd(a)) {
                        a = new _.Fb(a,_.Kb);
                        break a
                    }
                }
        ...
        _.ul = function(a, b, c, d) {
            if (0 === a.length)
                throw Error("U");
            a = a.map(function(f) {
                if ("function" == typeof _.kk && f instanceof _.kk)
                    f = f.g;
                else
                    throw Error("U");
                return f
    ...
    try {
        ...
        _.em = function(a) {
            var b = {};
            if (a)
                for (var c = _.ha(Object.keys(a)), d = c.next(); !d.done; d = c.next())
                    d = d.value,
        ...
        ;
        _.im.prototype.ba = function() {
            _.im.ra.ba.call(this);
            _.jm(this);
            delete this.i
        }
        ;
        ...
        _.db(_.km, _.Sb);
        var lm = [];
        _.km.prototype.K = function(a, b, c, d) {
            Array.isArray(b) || (b && (lm[0] = b.toString()),
            b = lm);
        ...
        ;
        _.km.prototype.Mb = function(a, b, c, d) {
            return mm(this, a, b, c, d)
        }
        ;
        ...
        _.km.prototype.Ga = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++)
                    this.Ga(a, b[f], c, d, e);
            else
        ...
        _.km.prototype.ba = function() {
            _.km.ra.ba.call(this);
            nm(this)
        }
        ;
        _.km.prototype.handleEvent = function() {
            throw Error("ta");
        }
        ;
    } catch (e) {
    ...
    try {
        ...
        _.Gm = function(a, b) {
            ...
            if (!b || b.closed || "undefined" === typeof b.closed)
                return _.A("Failed to open popup window on url: " + a + ". Maybe blocked by the browser?"),
                null;
            b.focus();
            return b
        }
    ...
    try {
        ...
        ;
        _.Wn = function(a) {
            _.Tn(window.parent, a, _.Vn)
        }
        ;
        _.co = function(a, b, c) {
            Xn ? _.y("A previous attempt has been made to verify the parent origin and is still being processed.") : _.Vn ? (_.x("Parent origin has already been verified."),
            b && b()) : Yn(a) ? (Zn = a,
            $n(),
            a = _.Un(),
            _.Tn(window.parent, {
            ...
            Xn = a,
            ao = b,
            bo = c) : _.A("Invalid origin provided. Please provide a valid and secure (https) origin. If providing a list of origins, make sure all origins are valid and secure.")
        }
        ;
        Yn = function(a) {
            if ("function" === typeof a)
        ...
        eo = function(a) {
            try {
                ...
                if (!c.startsWith("*"))
                    return !0;
                if (!c.startsWith("*."))
                    return _.A("Invalid origin pattern. Valid patterns should start with '*.'"),
                    !1;
                a = c;
                b = "Kb";
                if (fo.Kb && fo.hasOwnProperty(b))
                    var d = fo.Kb;
                else {
                    var e = new fo;
                    d = fo.Kb = e
                ...
                if (2 > c.indexOf("." + k))
                    return _.A("Invalid origin pattern. Patterns cannot be composed of a wildcard and a top level domain."),
                    !1
            } catch (l) {
                return !1
            }
        ...
        ;
        $n = function() {
            ho || (ho = _.C(window, "message", function(a) {
                a = a.g;
                if (a.data) {
                    var b = a.data;
                    "onetap_google" === b.sentinel && "parent_frame_ready" === b.command && (_.x("Message received: " + JSON.stringify(b)),
                    window.parent && window.parent === a.source ? Xn ? b.nonce !== Xn ? _.y("Message ignored due to invalid nonce.") : (io(a.origin) ? (_.Vn = a.origin,
                    _.jo = b.parentMode || "amp_client",
                    ao && ao()) : (_.y("Origin verification failed. Invalid origin - " + a.origin + "."),
                    bo && bo()),
                    bo = ao = Xn = void 0,
                    ho && (_.qc(ho),
                    ho = void 0)) : _.y("Message ignored. Origin verifier is not ready, or already done.") : _.y("Message ignored due to invalid source."))
                }
            }))
        }
        ;
        io = function(a) {
            return "string" === typeof Zn ? ko(Zn, a) : Array.isArray(Zn) ? Zn.some(function(b) {
                return ko(b, a)
            }) : !1
        }
        ;
        ...
        var Zn, ho, Xn, ao, bo;
        _.B("google.accounts.id.intermediate.verifyParentOrigin", _.co);
        _.B("google.accounts.id.intermediate.notifyParentResize", _.lo);
        _.B("google.accounts.id.intermediate.notifyParentClose", _.mo);
        ...
        _.B("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.no);
    } catch (e) {
        _._DumpException(e)
    }
    try {
        var Z = function(a, b) {
          ...
          , vo = function(a, b, c, d) {
            _.Xe(a, function(e) {
                d(_.ye(e.target))
            }, "POST", b ? _.Tc(_.em(b)).toString() : null, void 0, void 0, c)
        }
          , wo = function(a, b, c) {
            vo(a, b, !0, c)
        }
          ...
          , yo = function() {
            for (var a = _.ha(document.getElementsByTagName("META")), b = a.next(); !b.done; b = a.next())
                if (b = b.value,
          ...
          , Do = function() {
            ...
            "http" === c.h && "localhost" === c.g && (b.Tb = void 0,
            b.Sb = void 0);
            _.fd.set("g_csrf_token", a, b);
            return a
        }
          , Ho = function(a, b, c) {
            Eo = a ? a + "/gsi/log" : "https://accounts.google.com/gsi/log";
            Fo = b;
            Go = c
        }
          , Jo = function(a, b) {
            Io >= (void 0 === b ? 100 : b) || (b = new _.Bc(Eo),
            _.Ec(b, _.Tc({
                client_id: Fo,
                as: Go,
                event: a.toString()
            })),
            _.Xe(b.toString(), void 0, "POST", void 0, void 0, void 0, "https://accounts.google.com/gsi/log" !== Eo))
        }
          , No = function(a) {
            var b = new (Function.prototype.bind.apply(Ko, [null, "onetap", a, "prompt"].concat(Lo(Mo.apply(1, arguments)))));
            Jo(b)
        }
          , Oo = function() {
            var a = new (Function.prototype.bind.apply(Ko, [null, "onetap", void 0, "closed"].concat(Lo(Mo.apply(0, arguments)))));
            Jo(a)
        }
          , Po = function() {
            var a = new (Function.prototype.bind.apply(Ko, [null, "id", void 0, "init"].concat(Lo(Mo.apply(0, arguments)))));
            Jo(a)
        }
          , Qo = function() {
            var a = new (Function.prototype.bind.apply(Ko, [null, "onetap", void 0, "policy"].concat(Lo(Mo.apply(0, arguments)))));
            Jo(a)
        }
          , To = function(a) {
            var b = void 0 === b ? "googleidentityservice" : b;
            if (!(document.getElementById(b) && Ro.get(b) && Ro.get(b))) {
                var c = new _.wf
          ...
          , Xo = function(a, b, c, d) {
            ...
            e.id = c;
            e.title = 'Bot\u00e3o "Fazer login com o Google"';
          ...
          , bp = function(a, b, c) {
            ...
            var f = _.C(document, "securitypolicyviolation", function(g) {
                g.blockedURI && (Qo("cspHeaderViolation", "blockedURI=" + g.blockedURI),
                _.qc(f))
            });
            b = new _.Bc(e);
            _.Ec(b, _.Tc({
          ...
          , cp = function(a, b, c) {
            if (document.location.ancestorOrigins && 0 < document.location.ancestorOrigins.length) {
                var d;
                (d = (new _.Bc(document.location.ancestorOrigins[document.location.ancestorOrigins.length - 1])).g.replace("www.", "")) && !document.location.hostname.includes(d) && (Ho(b, a, c),
                Qo("nestedIframeCrossOrigin", "topDomain=" + d, "iframeHost=" + document.location.hostname, "path=" + document.location.pathname))
            }
        }
          , ip = function() {
            ...
            if (a) {
                ...
                var c = {}, d;
                for (d in b)
                    b.hasOwnProperty(d) && 0 > ep.indexOf(d.toLowerCase()) && (c[d] = b[d]);
                ...
                if (d = a.login_uri) {
                    ...
                    if ("https" !== b.h && "localhost" !== b.g)
                        throw Po("unsecuredLoginUri", d),
                        new fp("Unsecured login_uri provided.");
                    d = b.toString();
                    a.login_uri = d
                }
                d && !a.callback && (a.callback = gp(d, c));
                ...
                d && a.native_callback ? _.A("Cannot set both data-native_login_uri and data-native_callback.") : d && (a.native_callback = hp(d, c, a.native_id_param || "email", a.native_password_param || "password"));
                return a
            }
        }
          , gp = function(a, b) {
            return function(c) {
                ...
                b.g_csrf_token = Do(),
                _.hm(a, b)) : Z("No credential found in the response.")
            }
        }
          , hp = function(a, b, c, d) {
            return function(e) {
                ...
                b[d] = e.password,
                _.hm(a, b)) : Z("No password credential returned.")
            }
        }
          , kp = function(a) {
            a = _.Qn(a);
          ...
          , op = function(a) {
            a = new lp(a);
            mp.__G_ID_CLIENT__ = a;
            To(a.ed);
            np(a);
            return a
        }
          , pp = function(a, b, c) {
            var d = mp.__G_ID_CLIENT__;
            d || (op(),
            d = mp.__G_ID_CLIENT__);
            d.Y(a, b, c)
        }
          , rp = function(a, b, c) {
            if (a && b) {
                var d = mp.__G_ID_CLIENT__;
                d ? qp(d, a, b, c) : _.y("Failed to render button before calling initialize().")
            } else
                _.y("Failed to render button because there is no parent or options set.")
        }
          , tp = function() {
            var a = mp.__G_ID_CLIENT__;
            a || (op(),
            a = mp.__G_ID_CLIENT__);
            sp(a.u)
        }
          , up = function() {
            var a = void 0 === a ? document.readyState : a;
            for (var b = _.Se("g_id_signout"), c = 0; c < b.length; c++)
                _.C(b[c], "click", tp);
            try {
                var d = ip();
                if (d) {
                    ...
                    op(d);
                    e && ("complete" === a ? pp(f) : _.C(window, "load", function() {
                        pp(f)
                    }, !1))
                }
          ...
          , vp = function() {
            var a = mp.onGoogleLibraryLoad;
            a && "function" === typeof a && a()
        }
          , wp = function() {
            if (Bo() && (_.P("enable_fedcm_beta_launch") || _.P("enable_fedcm_global_origin_trial"))) {
          ...
          , zp = function(a, b, c) {
            ...
            yp(c, "access_type", g);
            yp(c, "hd", n);
            yp(c, "response_type", f);
            yp(c, "include_granted_scopes", !1 === p ? "false" : "true");
            yp(c, "enable_granular_consent", !1 === r ? "false" : "true");
            return b + "?" + c.join("&")
        }
          , Bp = function(a, b) {
            if (!b.client_id)
                throw new Ap("Missing required parameter client_id.","missing_required_parameter");
            if (!b.scope)
                throw new Ap("Missing required parameter scope.","missing_required_parameter");
            var c = {
          ...
          , Dp = function(a) {
            return (a = a && a.scope && a.scope.trim()) ? Cp.apply(null, Lo(a.split(" "))) : null
        }
          , Ep = function(a) {
          ...
          , So = function(a, b) {
            ...
            if (_.wa("", "stylesheet")) {
                ...
                a: {
                    ...
                    if (b.querySelector && (b = b.querySelector('style[nonce],link[rel="stylesheet"][nonce]')) && (b = b.nonce || b.getAttribute("nonce")) && Gp.test(b))
                        break a;
                    b = ""
                }
                b && a.setAttribute("nonce", b)
            } else
                a.href = b instanceof _.Oe ? _.Pe(b).toString() : b instanceof _.Fb ? _.Gb(b) : _.Gb(_.gm(b))
        }
          , Zo = function(a, b) {
            if ("textContent"in a)
                a.textContent = b;
        ...
        var Qp = {
          ...
          , Wp = function(a, b, c) {
            ...
            this.g = !1;
            a = new _.ej;
            if (b && (b.logo_alignment && _.N(a, 6, Qp[b.logo_alignment]),
            b.shape && _.N(a, 3, Rp[b.shape]),
            b.size && _.N(a, 1, Sp[b.size]),
            b.text && _.N(a, 5, Tp[b.text]),
            b.theme && _.N(a, 2, Up[b.theme]),
            b.type && _.N(a, 7, Vp[b.type]),
            b.width))
        ...
        ;
        var Vo = function() {
            return 'Caixa de di\u00e1logo "Fazer login com o Google"'
        };
        var Ko = function(a, b, c) {
            var d = Mo.apply(3, arguments);
            this.j = a;
            this.i = b;
            this.g = c;
            this.h = d
        ...
        Ko.prototype.toString = function() {
            ...
            this.h && a.push.apply(a, Lo(this.h));
            return a.join(".")
        }
        ;
        var Io = Math.floor(100 * Math.random()), Eo = "https://accounts.google.com/gsi/log", Fo, Go;
        var Ro = new Map;
        var Zp = [0, 7200, 86400, 604800, 2419200]
          , $p = function(a, b, c) {
            this.i = a;
        ...
        var fq = RegExp("^((?!\\s)[a-zA-Z0-9\u0080-\u3001\u3003-\uff0d\uff0f-\uff60\uff62-\uffffFF-]+[\\.\\uFF0E\\u3002\\uFF61])+(?!\\s)[a-zA-Z0-9\u0080-\u3001\u3003-\uff0d\uff0f-\uff60\uff62-\uffffFF-]{2,63}$");
        var gq = function() {};
        gq.prototype.next = function() {
            return hq
        }
        ;
        var hq = {
        ...
        ;
        var lq = function(a) {
            if (a instanceof iq || a instanceof jq || a instanceof kq)
                return a;
            if ("function" == typeof a.next)
                return new iq(function() {
                    return a
                }
                );
        ...
        ;
        var rq = new _.Im("g_credential_picker")
          , tq = function(a, b) {
            b = void 0 === b ? "i_" : b;
            var c = new pq;
            if (c.g)
                ...
                d = !1;
            this.I = d ? new qq(c,"g_state_id_") : null;
            this.md = b;
            ...
            this.o = btoa(String.fromCharCode.apply(String, Lo(b))).replace(/=+$/, "");
            this.C = new Map;
            this.ab = this.bb = !1;
            sq(this, a)
        };
        ...
        var sq = function(a, b) {
            ...
            a.od = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
            a.oc = b.status_url || "https://accounts.google.com/gsi/status";
            a.B = _.On(a.oc);
            a.ed = b.container_css_url || "https://accounts.google.com/gsi/style";
            a.sd = b.revoke_url || "https://accounts.google.com/gsi/revoke";
            a.ld = b.fedcm_url || "https://accounts.google.com/gsi/";
            a.kd = b.fedcm_config_url || "https://accounts.google.com/gsi/fedcm.json";
            Ho(a.B, b.client_id, a.o);
            a.callback = b.callback;
            a.sa = "redirect" === b.ux_mode ? "redirect" : "popup";
            c = b.ui_mode;
            void 0 !== c && Object.values(Jp).includes(c) || (c = _.xj() && !_.yj() ? "bottom_sheet" : "card");
            a.J = c;
            ...
            !c || null != c && fq.test(c) || (c = void 0);
            a.u = new $p(c,a.md,b.state_cookie_name);
            a.jc(b);
            c = {};
            ...
            c.ui_mode = a.J;
            void 0 !== b.context && Object.values(Ip).includes(b.context) && (c.context = b.context);
        ...
        var np = function(a) {
          ...
          , yq = function(a) {
            ...
            if (b)
                return !1;
            b = a.g.client_id;
            if (_.P("enable_fedcm_idp_signin_status_origin_trial") && !Lp.idpSigninStatus) {
                var c = document.createElement("meta");
                c.httpEquiv = "origin-trial";
                c.content = b && Kp[b] ? Kp[b] : "";
                document.getElementsByTagName("head")[0].appendChild(c);
                Lp.idpSigninStatus = !0
            }
            !(b = a.ha && (_.P("enable_fedcm_beta_launch") || _.Ej.enable_fedcm.includes(a.g.client_id))) && (b = void 0 === a.ha) && (a = _.Ej.enable_fedcm.includes(a.g.client_id) && _.P("enable_fedcm_via_userid"),
            b = _.P("enable_fedcm_idp_signin_status_origin_trial"),
            b = a || b || _.P("enable_fedcm_global_origin_trial"));
            return b
        }
          , Aq = function(a) {
            ...
            navigator.credentials.get(b).then(function(c) {
                ...
                var e = function(f) {
                    a.callback && (f = {
                        ...
                        select_by: f && f.isAccountAutoSelected ? "fedcm_auto" : "fedcm"
                    },
                    zq({
                        data: {
                            announcement: _.Xf({})
        ...
        tq.prototype.Y = function(a, b, c) {
            var d = this;
            b = Object.assign({}, this.h, b);
            _.P("enable_fedcm_compliance_detection") && (b.prompt_parent_id || b.prompt_parent) && Qo("defaultPosition");
            sq(this, b);
            b = "bottom_sheet" === this.g.ui_mode ? "bottomSheet" : "card";
            _.P("enable_fedcm_compliance_detection") && Co() && (Qo("oneTapNestedInIframe"),
            cp(this.h.client_id ? this.h.client_id : "", this.B, this.o));
            _.P("enable_fedcm_csp_compliance_detection") && bp(this.h.client_id ? this.h.client_id : "", this.B, this.o);
            window.location.href.startsWith("chrome-extension://") ? (_.y("Attempted to start sign in flow inside chrome extension."),
            No(b, "chromeExtension")) : (wq(this, !0) && (Bq(this, "flow_restarted"),
            Oo("flowRestarted")),
            _.P("enable_fedcm_compliance_detection") && a && Qo("uiEvents"),
            this.l = a,
            this.ua = c,
            this.g.client_id ? _.P("unsupported_browser") ? (Z("One Tap is not supported in this User Agent."),
            this.j("browser_not_supported"),
            _.tf(this, "prompt_display_failed", {
                cause: "Unsupported user agent for one tap."
            }),
            No(b, "browserNotSupported")) : dq(this.u) ? (Z("User has closed One Tap before. Still in the cool down period."),
            this.j("suppressed_by_user"),
            _.tf(this, "prompt_display_failed", {
                cause: "Prompt disabled by the user."
            }),
            No(b, "cooldown", (bq(this.u).prompt_suppress_level || 0).toString())) : yq(this) ? Aq(this) : Cq(this, function(e) {
                e && _.L(e, 3) ? (Dq(d),
                Eq(d),
                Fq(d, !0)) : e && _.hf(e, _.qf, 2) ? (_.id(_.M(e, _.qf, 2)),
                e = _.M(e, _.qf, 2),
                e = _.E(e, 1),
                ...
                })) : e && !_.L(e, 3) && _.Bj() && d.bb ? (d.g.is_itp = !0,
                Dq(d),
                Eq(d),
                Fq(d, !0),
                delete d.g.is_itp) : e && !_.L(e, 3) ? (_.x("No sessions found in the browser."),
        ...
        var qp = function(a, b, c, d) {
            ...
            _.Ec(f, d);
            g = _.zj();
            f = Xo(h, f.toString(), e, g);
            c.Ta = f.Ta;
            g && f.zc && Ao(f.zc, function(k) {
                k.preventDefault();
                k.stopPropagation();
                Hq(a, e)
            })
            ...
            if (c && c.Jb) {
                ...
                requestAnimationFrame(function() {
                    requestAnimationFrame(function() {
                        ...
                        e && Jo(new Ko("button",void 0,"rendered","latency",Math.floor(d.i - e).toString(),Math.floor(d.j - e).toString(),Math.floor(d.startTime - e).toString()), 1)
                    })
                })
            }
        }
          , Hq = function(a, b) {
            ...
            if (b) {
                ...
                wq(a, !0) && (Bq(a, "flow_restarted"),
                Oo("buttonFlowStarted")),
                ...
                b = top.location,
                a = _.tl(_.fm(a.kc, a.g)),
                a = _.sl(a),
                void 0 !== a && b.replace(a)) : (a.m = _.Un(),
                a.g.channel_id = _.ld(a.m),
                a.g.origin = a.g.origin || location.origin,
                _.Gm(_.fm(a.kc, a.g), rq) || Jo(new Ko("button","popup","clicked","popupNotOpened"))),
                d.qc && d.qc(Object.assign({}, d.data))) : _.A("A button entry was not found for the given id.")
            }
        }
          , wq = function(a, b) {
            if (a.ab)
                return a.G ? (a.G.abort(),
                a.G = null,
                !0) : !1;
            if (ap(a.s))
                var c = !a.H;
            ...
            if (!b && a.F)
                ...
                !1;
            ap(a.s) ? ((b = a.H) && b.parentElement ? ("credential_picker_container" === b.parentElement.id && b.parentElement.parentElement ? b.parentElement.parentElement.removeChild(b.parentElement) : b.parentElement.removeChild(b),
            b = !0) : b = !1,
            b = !b) : b = !Uo(a.s);
            if (b)
        ...
        var Fq = function(a, b, c) {
          ...
          , Cq = function(a, b) {
            ...
            c = _.fm(a.oc, c);
            uo(c, function(d) {
                d && "null" !== d ? (d = Np(JSON.stringify(_.ae(d))),
                b(d)) : (_.A("Check credential status returns invalid response."),
                a.j("unknown_reason"),
                _.tf(a, "network", {
          ...
          , Dq = function(a) {
            ...
            if (c = a.g.auto_select) {
                c = a.u;
                var d = bq(c);
                d.disable_auto_select_to && Date.now() >= d.disable_auto_select_to && (eq(c),
                d = bq(c));
        ...
        tq.prototype.mc = function(a) {
            this.H = Wo(this.s, a, "bottom_sheet" === this.J)
        }
        ;
        var Eq = function(a) {
            "bottom_sheet" === a.J && window.setTimeout(function() {
                wq(a, !1) && (xq(a, "auto_cancel"),
                Oo("autoCancel"))
            }, a.nd)
        }
          , vq = function(a, b) {
                                        ...
                                        case "resize":
                                            ...
                                            if (f) {
                                                ...
                                                if (g && g.Ta && Yo(h) && Yo(k)) {
                                                    ...
                                                    "number" !== typeof g || isNaN(g) || "number" !== typeof e || isNaN(e) || (l.style.marginTop = g + "px",
                                                    ...
                                                    l ? _.y("Unable to resize iframe. Invalid dimensions.") : _.y("Unable to resize iframe. No iframe found with id: " + (f + "."))
                                            }
                                            break;
                                        default:
            ...
            if (a.data && a.data.type)
                ...
                case "response":
                    ...
                    if (d) {
                        ...
                        f.prompt_suppress_level && Jo(new Ko("onetap",void 0,"resetCooldown",f.prompt_suppress_level.toString()));
                    ...
                    b && (d ? Bq(this, "credential_returned") : (xq(this, "issuing_failed"),
                    Oo("issuingFailed")),
                    Ep(this));
                    zq(a);
                    break;
                ...
                case "command":
                    if (b = a.data.command)
                        switch (b) {
                        case "close":
                            a.data.suppress && (a = this.u,
                            b = bq(a),
                            b.prompt_suppress_level = Math.min(b.prompt_suppress_level + 1, 4),
                            b.disable_auto_prompt = (new Date).getTime() + 1E3 * Zp[b.prompt_suppress_level],
                            Jo(new Ko("onetap",void 0,"startCooldown",b.prompt_suppress_level.toString())),
                            cq(a, b));
                            wq(this, !0) && (xq(this, "user_cancel"),
                            Ep(this),
                            Oo("userCancel"));
                            break;
                        case "resize":
                            a = a.data.height;
                            if (Yo(a)) {
                                if (this.s !== document.body && ap(this.s))
                                    (b = this.H) ? (d = b.clientHeight,
                        ...
                        case "start_auto_select":
                            Jq(this, "auto_select_started");
                            break;
                        case "cancel_auto_select":
                            sp(this.u),
                            Jq(this, "auto_select_canceled")
                        }
                }
        }
        ;
        var zq = function(a) {
            a.data.announcement && $o(a.data.announcement)
        };
        tq.prototype.revoke = function(a, b) {
            var c = {
                successful: !1
            }
              , d = this.g.client_id;
            ...
            this.o && (a.as = this.o),
            wo(this.sd, a, function(e) {
                if (e && "null" !== e) {
                    if (e = Pp(JSON.stringify(_.ae(e))),
                    ...
                    _.A("Invalid response is returned for revoke request."),
            ...
            if (this.i && this.i)
                if ("string" === typeof this.i) {
                    ...
                    for (a = 0; a < this.i.length; a++)
                        if ("string" !== typeof this.i[a] || !xo(this.i[a]))
                            throw Error("ya");
        };
        _.J(lp, tq);
        lp.prototype.jc = function(a) {
            this.V = a.native_callback
        }
        ;
        lp.prototype.j = function(a) {
            _.x("Prompt will not be displayed");
            this.V && Kq(this);
            tq.prototype.j.call(this, a)
        }
        ;
        var Kq = function(a) {
            a.eb || (a.eb = !0,
        ...
        lp.prototype.Y = function(a, b, c) {
            var d = this;
            this.T && this.i ? (_.x("Verifying parent origin."),
            _.co(this.i, function() {
                _.Vn ? _.Wn({
                    command: "set_ui_mode",
                    mode: d.J
                ...
                _.no(!1);
                d.lc = !1;
                tq.prototype.Y.call(d, a, b, c)
            })) : tq.prototype.Y.call(this, a, b, c)
        }
        ;
        lp.prototype.na = function(a) {
            tq.prototype.na.call(this, a);
            if (this.T && a.data && a.data.type)
                switch (a.data.type) {
                case "response":
                    a.data.response && a.data.response.credential && (this.lc = !0,
                    _.lo(0));
                    break;
                case "command":
                    switch (a.data.command) {
                    case "close":
                        this.lc ? _.lo(0) : this.Za ? (_.lo(0),
                        this.Za()) : _.mo();
                        break;
                    case "resize":
                        a = a.data.height;
                        "number" === typeof a && !isNaN(a) && 0 < a && _.lo(a);
                        break;
                    case "cancel_protect_start":
                        _.no(!1);
                        break;
        ...
        ;
        lp.prototype.mc = function(a) {
            this.H = Wo(this.s, a, "bottom_sheet" === this.J, this.T)
        }
        ;
        lp.prototype.fb = function(a) {
            if (this.T)
                switch (_.jo) {
        ...
        (function(a) {
            ...
            "loading" !== a ? (wp(),
            up(),
            xp()) : _.C(document, "DOMContentLoaded", function() {
                wp();
                up();
                xp()
            }, !1)
        ...
        _.B("google.accounts.id.cancel", function() {
            var a = mp.__G_ID_CLIENT__;
            a && wq(a, !0) && (Bq(a, "cancel_called"),
            Oo("cancel"))
        });
        _.B("google.accounts.id.disableAutoSelect", tp);
        _.B("google.accounts.id.initialize", op);
        _.B("google.accounts.id.prompt", pp);
        _.B("google.accounts.id.PromptMomentNotification", Yp);
        _.B("google.accounts.id.renderButton", rp);
        _.B("google.accounts.id.revoke", function(a, b) {
            var c = mp.__G_ID_CLIENT__;
        ...
        _.B("google.accounts.id.setLogLevel", function(a) {
            var b = mp.__G_ID_CLIENT__;
            b || (op(),
            b = mp.__G_ID_CLIENT__);
            a = a ? a.toLowerCase() : void 0;
            void 0 === a || 0 <= (0,
            _.Na)(Hp, a) ? uq(b, a, !0) : (_.A("Log level is invalid. Supported log levels are: info, warn, error. Log level set to warn by default"),
            uq(b, void 0, !0))
        });
        var Lq = function(a, b) {
        ...
        Lq.prototype.C = function() {
            ...
            this.error_callback && this.error_callback(new Ap("Popup window closed","popup_closed")),
            _.jm(this.g),
            this.h = this.g = void 0)
        }
        ;
        var Pq = new _.Im("g_auth_code_window")
          , Qq = function(a) {
            Lq.call(this, "code", a);
        ...
        Qq.prototype.i = function(a) {
            ...
            Lq.prototype.i.call(this, a);
            this.callback && this.callback.call(this, a)
        }
        ;
        Qq.prototype.requestCode = function() {
            var a = this.o;
            "redirect" === this.sa ? (Z("Starting redirect flow.", "CODE_CLIENT"),
            _.vl(window.location, _.tl(zp(this.l, this.m, a)))) : (Z("Starting popup flow.", "CODE_CLIENT"),
            Mq(this),
            Nq(this, a),
            this.h = _.Gm(zp(this.l, this.m, a), Pq),
            !this.h && this.error_callback ? this.error_callback(new Ap("Failed to open popup window","popup_failed_to_open")) : Oq(this))
        }
        ;
        var Rq = new _.Im("g_auth_token_window")
          , Sq = window
          , Tq = function(a) {
            Lq.call(this, "token", a);
            this.callback = a.callback;
        ...
        Tq.prototype.i = function(a) {
            ...
            if (a.access_token)
                if (Sq.gapi && Sq.gapi.client && Sq.gapi.client.setToken)
                    try {
                        Sq.gapi.client.setToken.call(this, a)
                    } catch (b) {
        ...
        ;
        Tq.prototype.requestAccessToken = function(a) {
            var b = this.o;
            a = a || {};
            ...
            Mq(this);
            Nq(this, b);
            this.h = _.Gm(zp(this.l, this.m, b), Rq);
            !this.h && this.error_callback ? this.error_callback(new Ap("Failed to open popup window","popup_failed_to_open")) : Oq(this)
        }
        ;
        _.B("google.accounts.oauth2.GoogleIdentityServicesError", Ap);
        _.B("google.accounts.oauth2.GoogleIdentityServicesErrorType", {
            Ud: "unknown",
            Pd: "missing_required_parameter",
            Rd: "popup_failed_to_open",
            Qd: "popup_closed"
        });
        _.B("google.accounts.oauth2.initCodeClient", function(a) {
            return new Qq(a)
        });
        _.B("google.accounts.oauth2.CodeClient", Qq);
        _.B("google.accounts.oauth2.initTokenClient", function(a) {
            return new Tq(a)
        });
        _.B("google.accounts.oauth2.TokenClient", Tq);
        _.B("google.accounts.oauth2.hasGrantedAllScopes", function(a) {
            var b = Mo.apply(1, arguments)
              , c = Dp(a);
            return c && c.length ? (b = Cp.apply(null, Lo(b))) && b.length ? (0,
            _.pb)(b, function(d) {
                return 0 <= (0,
                _.Na)(c, d)
            }) : !1 : !1
        ...
        _.B("google.accounts.oauth2.revoke", function(a, b) {
            ...
            vo("https://oauth2.googleapis.com/revoke", a, !1, function(c) {
