...
!function(e, n) {
  ...
  var t = ["onChange", "onClose", "onDayCreate", "onDestroy", "onKeyDown", "onMonthChange", "onOpen", "onParseConfig", "onReady", "onValueUpdate", "onYearChange", "onPreCalendarPosition"]
    ...
    , i = {
      ...
      rangeSeparator: " até ",
      weekAbbreviation: "Wk",
      scrollTitle: "Role para incrementar",
      ...
      return function(e, n, i, o) {
          if (0 === e || e) {
              ...
              if (l instanceof Date && !isNaN(l.getTime()))
                  ...
                  l;
              t.errorHandler(new Error("Data inválida: " + s))
          }
      }
  };
  function M(e, n, t) {
  ...
  "function" != typeof Object.assign && (Object.assign = function(e) {
      for (var n = [], t = 1; t < arguments.length; t++)
          n[t - 1] = arguments[t];
      if (!e)
          throw TypeError("Não é possível converter indefinido ou nulo em objeto");
  ...
  function k(p, v) {
      ...
      function j(e, n) {
          ...
          try {
              ...
              e.message = "Data inválida fornecida: " + t,
      ...
      function pe(e, n) {
          ...
          if (e instanceof Array)
              ...
              w.config.errorHandler(new Error("Data inválida fornecida: " + JSON.stringify(e)));
      ...
      return function() {
          ...
          function() {
              if (w.input = ce(),
              !w.input)
                  return void w.config.errorHandler(new Error("Elemento de entrada inválido especificado"));
