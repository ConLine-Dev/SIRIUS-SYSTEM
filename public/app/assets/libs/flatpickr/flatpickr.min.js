...
!(function (e, n) {
 "object" == typeof exports && "undefined" != typeof module
  ...
  ? define(n)
  : ((e = "undefined" != typeof globalThis ? globalThis : e || self).flatpickr =
     n());
})(this, function () {
 "use strict";
 var e = function () {
  ...
  function Me(e) {
   ...
   return w.selectedDates
    ...
    .filter(function (e, n, t) {
     return (
      "range" !== w.config.mode || w.config.enableTime || t.indexOf(e) === n
     );
    })
    .join(
     "range" !== w.config.mode ? w.config.conjunction : w.l10n.rangeSeparator
    );
  }
  function ye(e) {
   void 0 === e && (e = !0),
    ...
    (w.element = w.input = p),
     ...
     w.isMobile ||
      (function () {
       ...
       var i =
        void 0 !== w.config.appendTo && void 0 !== w.config.appendTo.nodeType;
       if (
