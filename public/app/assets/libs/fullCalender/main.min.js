...
var FullCalendar = (function (e) {
 ...
 class Hn {
  ...
  toDate(e, t) {
   return "local" === this.timeZone
    ...
    : this.namedTimeZoneImpl
    ? new Date(
       e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(Ht(e)) * 60
      )
 ...
 function ir(e, t) {
  ...
  return (
   null !== t.start &&
    (n =
     null === n ? t.start : new Date(Math.max(n.valueOf(), t.start.valueOf()))),
   null != t.end &&
 ...
 class gr {
  ...
  buildValidRange() {
   let e = this.props.validRangeInput,
    t =
     "function" == typeof e ? e.call(this.props.calendarApi, this.nowDate) : e;
   ...
   d = (function (e, t, n, r) {
    for (let i = 0; i < r.length; i += 1) {
     ...
     if (s) {
      ...
      return (
       null == n &&
        ((n = t), null == n && ((n = s.allDayGuess), null == n && (n = !1))),
 ...
 function Kr(e, t, n, r, i) {
  ...
  return (
   ...
   a &&
    (l.range = { start: l.range.start, end: Xr(t.allDay, l.range.start, i) }),
 ...
 function ci(e, t) {
  let n = [];
  return (
   t[""] && n.push(t[""]), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Pr(n)
  );
 }
 function di(e, t) {
  let n = e.map(ui);
 ...
 function qi(e, t, n = "day", r = !0) {
  ...
  if (s.navLinks) {
   ...
   const l = (e) => {
    let r =
     "day" === n ? s.navLinkDayClick : "week" === n ? s.navLinkWeekClick : null;
    "function" == typeof r
 ...
 class Fs extends Gn {
  ...
  render() {
   ...
   return (
    t &&
     (n ? i.push("fc-scroller-liquid-absolute") : i.push("fc-scroller-liquid")),
    p(
     "div",
     {
      ref: this.handleEl,
 ...
 class ha {
  ...
  processRawViewOptions(e, t, n, r, i) {
   ...
   return (
    d &&
     ((this.currentViewOptionsInput = s), (this.currentViewOptionsRefined = a)),
    {
  ...
  constructor(e) {
   super(e),
    ...
    (this.handleSegEnter = (e, t) => {
     ai(t) &&
      ((this.currentSegEl = t), this.triggerEvent("eventMouseEnter", e, t));
    }),
       ...
       if (e) {
        ...
        (e.componentId === t.componentId &&
         ...
         (r = (function (e, t, n) {
          ...
          return (
           (o.range = { start: s[0], end: s[3] }), (o.allDay = r.allDay), o
          );
 ...
 class Sl extends ls {
  ...
  render() {
   let { props: e, context: t } = this,
    ...
    c =
     n >= 7 && e.clientWidth ? e.clientWidth / t.options.aspectRatio / 6 : null;
 ...
 function ec(
  e,
  { todayRange: t, nowDate: n, eventSelection: r, eventDrag: i, eventResize: s }
 ) {
  let o =
